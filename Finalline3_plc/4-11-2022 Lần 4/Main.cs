...
namespace Finalline3_plc
{
    public partial class Main : Form
    {
        ...
        private async void Date_timer_Tick(object sender, EventArgs e)
        {
            await Task.Run(() =>
            {
        ...
        private async void timer_loadchan_Tick(object sender, EventArgs e)
        {
            await Task.Run(() =>
            {
                if (startt == "1")
        ...
        private async void timer_pokayoke_Tick(object sender, EventArgs e)
        {
            await Task.Run(() =>
            {
                if (foaam == true)
        ...
        {          
            await Task.Run(() => { timer_loadchan.Enabled = true;
